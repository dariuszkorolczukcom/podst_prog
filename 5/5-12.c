...
// Zadanie 5.12
// Napisz funkcję, która dla tablicy o wymiarze n danej jako parametr znajdzie i zwróci poprzez parametry wartość elementów minimalnego oraz indeks ostatniego jego wystąpienia w tablicy.