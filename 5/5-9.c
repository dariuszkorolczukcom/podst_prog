...
// Zadanie 5.9
// Napisz funkcję void usunPowtorzenia(int wej[], int wyj[], int n), która przyjmuje jako argumenty dwie tablice o rozmiarze n, a następnie przepisuje do tablicy wyj kolejne wartości z tablicy wej, pomijając powtórzenia i w razie czego uzupełniając tablicę zerami.
