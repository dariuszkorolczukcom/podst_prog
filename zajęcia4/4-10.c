...
// Zadanie 4.10
// Napisz program, który wczyta od użytkownika elementy dwuwymiarowej tablicy t[N][N], wypisze ją na ekran (każdy wiersz w nowej linii) i sprawdzi czy jest ona symetryczna. Uwzględnij wszystkie osi symetrii. Skorzystaj z funkcji stworzonych we wcześniejszych zadaniach.