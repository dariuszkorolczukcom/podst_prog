...
// Zadanie 5.11
// Napisz funkcję, która dla tablicy o wymiarze n danej jako parametr wyznaczy i zwróci liczbę elementów większych od średniej arytmetycznej wszystkich elementów tej tablicy.