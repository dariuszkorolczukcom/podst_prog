...
// Zadanie 5.13
// Napisz funkcję, która dla tablicy o wymiarze n danej jako parametr wyznaczy i zwróci średnią arytmetyczną elementów tablicy oraz liczbę elementów większych od tej średniej.