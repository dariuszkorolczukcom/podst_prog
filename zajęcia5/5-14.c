...
// Zadanie 5.14
// Napisz funkcję, która dla tablicy liczb całkowitych danej jako parametr obliczy i zwróci informację ile razy w tablicy występuje wartość maksymalna i ile razy występuje wartość minimalna.